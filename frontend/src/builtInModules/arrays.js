...
export default {
  ...
  sections: [
    { id: "introduction", title: "Introduction to arrays", blocks: [
      ...
      p("An array groups a fixed number of related values of the same type under one variable name. Each stored value is an element, and each element has a numbered position called an index."),
      heading("Why does it exist?"),
      p("Imagine tracking many lantern powers. Separate variables—lantern1, lantern2, lantern3—force you to repeat nearly identical code and make it difficult to process an unknown number of values. One array keeps the relationship clear and lets a loop visit the whole group."),
      code("int lantern1 = 10;\nint lantern2 = 20;\nint lantern3 = 30;", null, "Without an array"),
    ...
    { id: "declare", title: "Declaring and initializing", blocks: [
      ...
      list("int is the element type.", "[] says the variable holds an array.", "powers is the array variable name.", "{ 10, 20, 30 } lists the initial elements in order.", "The semicolon ends the declaration statement."),
    ...
    { id: "indexing", title: "Zero-based indexing", blocks: [
      ...
      code("int[] powers = { 10, 20, 30 };\nConsole.WriteLine(powers[1]);", "20"),
      note("Why is the output 20?", "powers[1] asks for the element at index 1. Index 1 is the second position because array indexing begins at 0."),
    ...
    { id: "changing", title: "Changing array values", blocks: [
      ...
      practice("arrays-change", "Change the last value to 6, then display it.", "int[] runes = { 2, 4, 0 };\n// Change index 2 here\nConsole.WriteLine(runes[2]);", "int[] runes = { 2, 4, 0 };\nrunes[2] = 6;\nConsole.WriteLine(runes[2]);", "6"),
    ]},
    { id: "length", title: "Length and valid bounds", blocks: [
      ...
      code("int lastIndex = charms.Length - 1;\nConsole.WriteLine(charms[lastIndex]);", "20", "Access the last element safely", false),
    ...
    { id: "practice", title: "Practice and quick assessment", blocks: [
      practice("arrays-loop", "Complete the loop body so it displays all three values.", "int[] values = { 4, 8, 12 };\nfor (int i = 0; i < values.Length; i++)\n{\n    // Display the current element\n}", "int[] values = { 4, 8, 12 };\nfor (int i = 0; i < values.Length; i++)\n{\n    Console.WriteLine(values[i]);\n}", "4\n8\n12"),
      practice("arrays-grid", "Display the value at row 1, column 0 in this 2x2 grid.", "int[,] map = {\n    { 1, 2 },\n    { 3, 4 }\n};\n// Display one cell", "int[,] map = {\n    { 1, 2 },\n    { 3, 4 }\n};\nConsole.WriteLine(map[1, 0]);", "3"),
