...
const LEVEL_CONFIG_BY_NUMBER = {
  ...
  7: {
    ...
    lessonKey: ARRAYS_LESSON_KEY,
    parTimeSeconds: 1200,
    title: "The Aswang's Stolen Supplies",
  ...
  11: {
    ...
    lessonKey: ARRAYS_LESSON_KEY,
    parTimeSeconds: 1200,
    title: "Tikbalang's Branching Path",
  ...
  26: {
    ...
    parTimeSeconds: 900,
    title: "Process the Lantern Line",
  ...
  28: {
    ...
    lessonKey: FUNCTIONS_ARRAYS_LESSON_KEY,
    parTimeSeconds: 900,
    title: "Restore the Warding Grid",
  ...
  29: {
    ...
    lessonKey: FUNCTIONS_ARRAYS_LESSON_KEY,
    parTimeSeconds: 900,
    title: "Ancient Cemetery of the Forgotten Spirits",
